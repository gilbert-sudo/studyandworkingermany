...
function App() {
  ...
  return (
    <>
      ...
      {/**/}
      <a href="#" id="go-to-top" className="fixed right-4 md:right-8 bottom-[5.5rem] md:bottom-8 z-40 p-3 rounded-full bg-brand-red text-white shadow-lg shadow-brand-red/30 hover:bg-red-700 hover:scale-110 active:scale-95 transition-all duration-300 opacity-0 pointer-events-none translate-y-4 flex items-center justify-center" aria-label="Go to top">
